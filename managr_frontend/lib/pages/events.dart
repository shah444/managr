        ...
        child: Center(
          child: FutureBuilder(
            ...
            if (snapshot.hasData) {
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(eventTitle, style: TextStyle(fontSize: 18),)
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(eventDetails, style: TextStyle(fontSize: 18),)
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text("Creation Date:", style: TextStyle(fontSize: 18),),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text("Room ID:", style: TextStyle(fontSize: 18),),
                          Text(room_id, style: TextStyle(fontSize: 18),)
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text("Invited Guests:", style: TextStyle(fontSize: 18),),
                          Text(invited_count, style: TextStyle(fontSize: 18), )
                        ],
                      ),
                    ),
                  ],
              ...
              return CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(onboardingStart),);
            }
          })
        ),
      ),
